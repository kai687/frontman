...
class Tilt::HamlTemplate < ::Tilt::Template
  # @raise [ArgumentError]
  #
  # source://tilt//lib/tilt/haml.rb#28
  ...
  #
  # source://tilt//lib/tilt/haml.rb#33
  def precompiled_template(locals); end

  # Following definitions are for Haml <= 4 and deprecated.
  #
  # source://tilt//lib/tilt/haml.rb#17
  def prepare; end
end
...
class Tilt::LiquidTemplate < ::Tilt::Template
  # @return [Boolean]
  #
  # source://tilt//lib/tilt/liquid.rb#36
  def allows_script?; end

  # source://tilt//lib/tilt/liquid.rb#25
  def evaluate(scope, locs); end

  # source://tilt//lib/tilt/liquid.rb#20
  def prepare; end
end
